...
from morshed_squad_files.core.constants import (
    MAX_CONCURRENCY,
    MULTIPART_CHUNKSIZE,
    MULTIPART_THRESHOLD,
)
from morshed_squad_files.core.sources import FileBytes, FilePath
...
class BedrockFileUploader(FileUploader):
    ...
    def __init__(
        ...
        prefix: str = "morshed_squad_files",
        ...
        Args:
            ...
            prefix: S3 key prefix for uploaded files (default: "morshed_squad_files").
