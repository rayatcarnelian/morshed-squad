...
from morshed_squad_files.cache.upload_cache import get_upload_cache
from morshed_squad_files.core.types import FileInput
from morshed_squad_files.formatting.anthropic import AnthropicFormatter
from morshed_squad_files.formatting.bedrock import BedrockFormatter
from morshed_squad_files.formatting.gemini import GeminiFormatter
from morshed_squad_files.formatting.openai import OpenAIFormatter, OpenAIResponsesFormatter
from morshed_squad_files.processing.constraints import get_constraints_for_provider
from morshed_squad_files.processing.processor import FileProcessor
from morshed_squad_files.resolution.resolver import FileResolver, FileResolverConfig
from morshed_squad_files.uploaders.factory import ProviderType
...
def format_multimodal_content(
    ...
    Example:
        >>> from morshed_squad_files import format_multimodal_content, ImageFile
