...
from morshed_squad_files.core.sources import is_file_source


if TYPE_CHECKING:
    from morshed_squad_files.core.sources import FileSource, FileSourceInput
...
def wrap_file_source(source: FileSource) -> FileInput:
    ...
    """
    from morshed_squad_files.core.types import (
        AudioFile,
        ImageFile,
        PDFFile,
        TextFile,
...
def normalize_input_files(
    ...
    """
    from morshed_squad_files.core.sources import FileBytes, FilePath, FileStream, FileUrl
    from morshed_squad_files.core.types import BaseFile
