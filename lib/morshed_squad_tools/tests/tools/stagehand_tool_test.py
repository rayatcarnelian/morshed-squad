...
def mock_stagehand_modules():
    ...
    from morshed_squad_tools.tools.stagehand_tool.stagehand_tool import (
        StagehandResult,
        StagehandTool,
    )
...
def mock_stagehand_instance():
    with patch(
        "morshed_squad_tools.tools.stagehand_tool.stagehand_tool.Stagehand",
...
@patch(
    "morshed_squad_tools.tools.stagehand_tool.stagehand_tool.StagehandTool._run", autospec=True
)
