...
from morshed_squad_tools.tools.parallel_tools.parallel_search_tool import (
    ParallelSearchTool,
)
...
@patch("morshed_squad_tools.tools.parallel_tools.parallel_search_tool.requests.post")
