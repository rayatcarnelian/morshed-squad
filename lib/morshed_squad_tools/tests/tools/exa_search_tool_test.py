...
from morshed_squad_tools import EXASearchTool
import pytest
...
def test_exa_search_tool_initialization():
    with patch.dict(os.environ, {}, clear=True):
        with patch(
            "morshed_squad_tools.tools.exa_tools.exa_search_tool.Exa"
        ) as mock_exa_class:
...
def test_exa_search_tool_initialization_with_env_base_url(
    ...
    with patch("morshed_squad_tools.tools.exa_tools.exa_search_tool.Exa") as mock_exa_class:
        EXASearchTool()
