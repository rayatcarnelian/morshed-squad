...
def test_default_initialization(tool):
    ...
    assert tool.name == "Generate Morshed Squad Automation"
...
def test_successful_generation_without_org_id(mock_post, tool):
    ...
    assert (
        result
        == "Generated Morshed Squad Studio project URL: https://app.crewai.com/studio/project-123"
    )
...
def test_successful_generation_with_org_id(mock_post, tool):
    ...
    assert (
        result
        == "Generated Morshed Squad Studio project URL: https://app.crewai.com/studio/project-456"
    )
    mock_post.assert_called_once_with(
        "https://app.crewai.com/crewai_plus/api/v1/studio",
        headers={
...
def test_api_response_missing_url(mock_post, tool):
    ...
    assert result == "Generated Morshed Squad Studio project URL: None"
