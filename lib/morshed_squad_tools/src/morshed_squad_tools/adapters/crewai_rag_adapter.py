"""Adapter for Morshed Squad's native RAG system."""
...
from morshed_squad.rag.config.utils import get_rag_client
from morshed_squad.rag.core.base_client import BaseClient
from morshed_squad.rag.factory import create_client
from morshed_squad.rag.types import BaseRecord, SearchResult
from pydantic import PrivateAttr
from pydantic.dataclasses import is_pydantic_dataclass
from typing_extensions import TypeIs, Unpack

from morshed_squad_tools.rag.data_types import DataType
from morshed_squad_tools.rag.misc import sanitize_metadata_for_chromadb
from morshed_squad_tools.tools.rag.rag_tool import Adapter
from morshed_squad_tools.tools.rag.types import AddDocumentParams, ContentItem
...
class MorshedSquadRagAdapter(Adapter):
    """Adapter that uses Morshed Squad's native RAG system.
    ...
    def model_post_init(self, __context: Any) -> None:
        """Initialize the Morshed Squad RAG client after model initialization."""
    ...
    def add(self, *args: ContentItem, **kwargs: Unpack[AddDocumentParams]) -> None:
        ...
        from morshed_squad_tools.rag.base_loader import LoaderResult
        from morshed_squad_tools.rag.data_types import DataType, DataTypes
        from morshed_squad_tools.rag.source_content import SourceContent
