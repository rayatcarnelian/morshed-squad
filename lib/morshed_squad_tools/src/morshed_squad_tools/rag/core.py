...
from morshed_squad_tools.rag.base_loader import BaseLoader
...
from morshed_squad_tools.rag.embedding_service import EmbeddingService
from morshed_squad_tools.rag.misc import compute_sha256
    ...
    def model_post_init(self, __context: Any) -> None:
        try:
            ...
            self._collection = self._client.get_or_create_collection(
                ...
                metadata={
                    "hnsw:space": "cosine",
                    "description": "Morshed Squad Knowledge Base",
                },
            )
