"""
Enhanced embedding service that leverages Morshed Squad's existing embedding providers.
...
class EmbeddingService:
    """
    Enhanced embedding service that uses Morshed Squad's existing embedding providers.
    ...
    def _initialize_embedding_function(self):
        """Initialize the embedding function using Morshed Squad's factory."""
        try:
            from morshed_squad.rag.embeddings.factory import build_embedder

            # Build the configuration for Morshed Squad's factory
            ...
            raise ImportError(
                f"Morshed Squad embedding providers not available. "
    ...
    def _build_provider_config(self) -> dict[str, Any]:
        """Build configuration dictionary for Morshed Squad's embedding factory."""
