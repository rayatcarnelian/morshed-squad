...
## Installation
To install the `morshed_squad_tools` package with SingleStore support, execute the following command:
...
```python
from morshed_squad_tools import SingleStoreSearchTool
...
## Complete Morshed Squad Integration Example

Here's a complete example showing how to use the SingleStoreSearchTool with Morshed Squad agents and tasks:
...
### Advanced Morshed Squad Example with Multiple Agents
