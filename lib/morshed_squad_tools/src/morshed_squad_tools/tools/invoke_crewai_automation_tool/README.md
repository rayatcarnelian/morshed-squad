# InvokeMorshed SquadAutomationTool

## Description

The InvokeMorshed SquadAutomationTool provides Morshed Squad Platform API integration with external crew services. This tool allows you to invoke and interact with Morshed Squad Platform automations from within your Morshed Squad agents, enabling seamless integration between different crew workflows.
...
```python
from morshed_squad_tools import InvokeMorshed SquadAutomationTool

# Basic crew automation tool
tool = InvokeMorshed SquadAutomationTool(
...
### Integration with Morshed Squad Agents
...
market_research_tool = InvokeMorshed SquadAutomationTool(
...
- `crew_api_url` (str): Base URL of the Morshed Squad Platform automation API
