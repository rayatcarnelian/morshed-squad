...
class InvokeMorshedSquadAutomationInput(BaseModel):
    """Input schema for InvokeMorshedSquadAutomationTool."""

    prompt: str = Field(..., description="The prompt or query to send to the crew")


class InvokeMorshedSquadAutomationTool(BaseTool):
    """A Morshed Squad tool for invoking external crew/flows APIs.

    This tool provides Morshed Squad Platform API integration with external crew services, supporting:
    ...
    Example:
        Basic usage:
        >>> tool = InvokeMorshedSquadAutomationTool(
    ...
    description: str = "Invokes an Morshed Squad Platform Automation using API"
    args_schema: type[BaseModel] = InvokeMorshedSquadAutomationInput
    ...
    def __init__(
        ...
        """Initialize the InvokeMorshedSquadAutomationTool.
        ...
        if crew_inputs:
            ...
            args_schema = create_model("DynamicInvokeMorshedSquadAutomationInput", **fields)  # type: ignore[call-overload]
        else:
            args_schema = InvokeMorshedSquadAutomationInput
