...
## Installation
To start using the DirectorySearchTool, you need to install the morshed_squad_tools package. Execute the following command in your terminal:
...
```python
from morshed_squad_tools import DirectorySearchTool
