...
## Installation
Install the `morshed_squad_tools` package to use the DirectoryReadTool in your project. If you haven't added this package to your environment, you can easily install it with pip using the following command:

```shell
pip install 'crewai[tools]'
```

This installs the latest version of the `morshed_squad_tools` package, allowing access to the DirectoryReadTool and other utilities.
...
```python
from morshed_squad_tools import DirectoryReadTool
