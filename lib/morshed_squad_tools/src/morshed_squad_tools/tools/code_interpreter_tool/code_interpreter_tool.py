...
from morshed_squad_tools.printer import Printer
...
class CodeInterpreterTool(BaseTool):
    ...
    def _get_installed_package_path() -> str:
        """Gets the installation path of the morshed_squad_tools package.
        ...
        """
        spec = importlib.util.find_spec("morshed_squad_tools")
        if spec is None or spec.origin is None:
            raise RuntimeError("Cannot find morshed_squad_tools package installation path")
