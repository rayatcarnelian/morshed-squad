...
## Installation
To start using the SerpApi Tools, you must first install the `morshed_squad_tools` package. This can be easily done with the following command:
...
### Google Search
```python
from morshed_squad_tools import SerpApiGoogleSearchTool
...
### Google Shopping
```python
from morshed_squad_tools import SerpApiGoogleShoppingTool
