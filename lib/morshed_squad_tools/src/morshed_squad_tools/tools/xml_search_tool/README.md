...
## Installation
To start using the XMLSearchTool, you must first install the morshed_squad_tools package. This can be easily done with the following command:
...
```python
from morshed_squad_tools.tools.xml_search_tool import XMLSearchTool
