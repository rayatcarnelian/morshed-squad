...
## Installation
To get started with the PDFSearchTool, first, ensure the morshed_squad_tools package is installed with the following command:
...
```python
from morshed_squad_tools import PDFSearchTool
