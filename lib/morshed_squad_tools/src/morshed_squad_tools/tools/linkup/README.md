...
The `LinkupSearchTool` is a tool designed for integration with the Morshed Squad framework. It provides the ability to query the Linkup API for contextual information and retrieve structured results. This tool is ideal for enriching workflows with up-to-date and reliable information from Linkup.
...
- Returns well-structured results for seamless integration into Morshed Squad processes.
...
Here is how to use the `LinkupSearchTool` in a Morshed Squad project:
