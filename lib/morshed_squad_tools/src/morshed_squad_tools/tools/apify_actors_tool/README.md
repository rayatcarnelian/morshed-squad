...
Integrate [Apify Actors](https://apify.com/actors) into your Morshed Squad workflows.

## Description

The `ApifyActorsTool` connects [Apify Actors](https://apify.com/actors), cloud-based programs for web scraping and automation, to your Morshed Squad workflows.
...
For details, see the [Apify Morshed Squad integration](https://docs.apify.com/platform/integrations/crewai) in Apify documentation.
...
```python
from morshed_squad_tools import ApifyActorsTool

# Initialize the tool with an Apify Actor
tool = ApifyActorsTool(actor_name="apify/rag-web-browser")

# Run the tool with input parameters
results = tool.run(run_input={"query": "What is Morshed Squad?", "maxResults": 5})
...
Content: Morshed Squad is a framework for building AI-powered workflows...
URL: https://docs.crewai.com/
Content: Official documentation for Morshed Squad...
```
...
For an example of usage with agents, see the [Morshed Squad Actor template](https://apify.com/templates/python-crewai).
...
- **[Morshed Squad Integration Guide](https://docs.apify.com/platform/integrations/crewai)**: Follow the official guide for integrating Apify and Morshed Squad.
