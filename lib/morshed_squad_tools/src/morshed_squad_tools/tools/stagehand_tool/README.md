...
This tool integrates the [Stagehand](https://docs.stagehand.dev/) framework with Morshed Squad, allowing agents to interact with websites and automate browser tasks using natural language instructions.
...
The StagehandTool wraps the Stagehand Python SDK to provide Morshed Squad agents with the ability to control a real web browser and interact with websites using three core primitives:
...
from morshed_squad_tools import StagehandTool
...
For questions about the Morshed Squad integration, join our [Slack](https://stagehand.dev/slack) or open an issue in this repository.