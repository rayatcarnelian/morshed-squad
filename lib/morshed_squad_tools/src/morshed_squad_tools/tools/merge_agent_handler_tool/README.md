...
### Step 2: Install Morshed Squad Tools

To incorporate this tool into your project, install Morshed Squad with tools support:
...
The following example demonstrates how to initialize a specific tool and use it with a Morshed Squad agent:

```python
from morshed_squad_tools import MergeAgentHandlerTool
