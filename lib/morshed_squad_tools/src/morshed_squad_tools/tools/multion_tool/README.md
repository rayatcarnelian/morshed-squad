...
from morshed_squad_tools import MultiOnTool
...
1. **Install Morshed Squad**: Confirm that the `crewai[tools]` package is installed in your Python environment.
