...
## Installation
To install the `morshed_squad_tools` package and utilize the MySQLSearchTool, execute the following command in your terminal:
...
```python
from morshed_squad_tools import MySQLSearchTool
