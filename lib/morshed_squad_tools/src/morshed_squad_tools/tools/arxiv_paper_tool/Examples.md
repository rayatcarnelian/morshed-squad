### Example 1: Fetching Research Papers from arXiv with Morshed Squad

This example demonstrates how to build a simple Morshed Squad workflow that automatically searches for and downloads academic papers from [arXiv.org](https://arxiv.org). The setup uses:
...
```
from morshed_squad import Agent, Task, Crew, Process, LLM
from morshed_squad_tools import ArxivPaperTool 
