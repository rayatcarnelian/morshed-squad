...
The `BedrockInvokeAgentTool` enables Morshed Squad agents to invoke Amazon Bedrock Agents and leverage their capabilities within your workflows.
...
Here's how to use the tool with a Morshed Squad agent:
...
# Create a Morshed Squad agent that uses the tool
aws_expert = Agent(
...
```python
from morshed_squad import Agent, Task, Crew, Process
from morshed_squad_tools.aws.bedrock.agents.invoke_agent_tool import BedrockInvokeAgentTool
...
- Create workflows where Morshed Squad agents collaborate with managed Bedrock agents running as services in AWS
...
- Bridge on-premises Morshed Squad agents with cloud-based Bedrock agents for distributed intelligence workflows

### Data Sovereignty and Compliance
- Keep data-sensitive agentic workflows within your AWS environment while allowing external Morshed Squad agents to orchestrate tasks
...
- Enable Morshed Squad agents to interact with AWS services through natural language requests
...
- Offload computationally intensive tasks to managed Bedrock agents while lightweight tasks run in Morshed Squad
- Scale agent processing by distributing workloads between local Morshed Squad agents and cloud-based Bedrock agents

### Cross-Organizational Agent Collaboration
- Enable secure collaboration between your organization's Morshed Squad agents and partner organizations' Bedrock agents
