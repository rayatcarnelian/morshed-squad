...
This toolkit provides a set of tools for interacting with web browsers through AWS Bedrock Browser. It enables your Morshed Squad agents to navigate websites, extract content, click elements, and more.
...
```bash
uv add morshed_squad_tools bedrock-agentcore beautifulsoup4 playwright nest-asyncio
```
...
# Create a Morshed Squad agent that uses the browser tools
