...
The `BedrockKBRetrieverTool` enables Morshed Squad agents to retrieve information from Amazon Bedrock Knowledge Bases using natural language queries.
...
from morshed_squad_tools.aws.bedrock.knowledge_base.retriever_tool import BedrockKBRetrieverTool
...
- Enable Morshed Squad agents to access your organization's proprietary knowledge without exposing sensitive data
...
- Connect Morshed Squad agents to domain-specific knowledge bases (legal, medical, technical) without retraining models
- Leverage existing knowledge repositories that are already maintained in your AWS environment
- Combine Morshed Squad's reasoning with domain-specific information from your knowledge bases

### Data-Driven Decision Making
- Ground Morshed Squad agent responses in your actual company data rather than general knowledge
...
- Ensure Morshed Squad agents provide responses that align with your company's approved documentation
