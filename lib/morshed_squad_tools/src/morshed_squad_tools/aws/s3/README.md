...
Install the morshed_squad_tools package
...
To use the AWS S3 tools in your Morshed Squad agents, import the necessary tools and include them in your agent's configuration:
...
These tools can be used to read from and write to S3 buckets within your Morshed Squad workflows. Make sure you have properly configured your AWS credentials as mentioned in the AWS Connectivity section above.
