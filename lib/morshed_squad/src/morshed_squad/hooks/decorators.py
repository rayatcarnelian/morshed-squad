...
if TYPE_CHECKING:
    ...
    from morshed_squad.hooks.tool_hooks import ToolCallHookContext
...
def before_llm_call(
    ...
    *,
    ...
    """
    from morshed_squad.hooks.llm_hooks import register_before_llm_call_hook
    ...
    Example:
        ...
        With agent filter::
            ...
            def log_researcher_responses(context):
                ...
                return None
    """
    from morshed_squad.hooks.llm_hooks import register_after_llm_call_hook
...
def before_tool_call(
    ...
    *,
    ...
    """
    from morshed_squad.hooks.tool_hooks import register_before_tool_call_hook
    ...
    Example:
        ...
        With tool filter::
            ...
            def sanitize_search_results(context):
                ...
                return None
    """
    from morshed_squad.hooks.tool_hooks import register_after_tool_call_hook
