...
from morshed_squad.events.types.llm_events import LLMCallType
from morshed_squad.llms.base_llm import BaseLLM, llm_call_context
from morshed_squad.llms.hooks.transport import AsyncHTTPTransport, HTTPTransport
from morshed_squad.utilities.agent_utils import is_context_length_exceeded
...
if TYPE_CHECKING:
    from morshed_squad.agent.core import Agent
    from morshed_squad.llms.hooks.base import BaseInterceptor
...
class OpenAICompletion(BaseLLM):
    ...
    def _convert_tools_for_responses(
        ...
        """Convert Morshed Squad tools to Responses API format.
        ...
        """
        from morshed_squad.llms.providers.utils.common import safe_tool_conversion
    ...
    def _prepare_completion_params(
        ...
        # Filter out Morshed Squad-specific parameters that shouldn't go to the API
        crewai_specific_params = {
            "callbacks",
            "available_functions",
            "from_task",
    ...
    def _convert_tools_for_interference(
        ...
        """Convert Morshed Squad tool format to OpenAI function calling format."""
        from morshed_squad.llms.providers.utils.common import safe_tool_conversion
        from morshed_squad.utilities.pydantic_schema_utils import (
    ...
    def get_context_window_size(self) -> int:
        ...
        from morshed_squad.llm import CONTEXT_WINDOW_USAGE_RATIO, LLM_CONTEXT_WINDOW_SIZES
    ...
    def get_file_uploader(self) -> Any:
        ...
        """
        try:
            from morshed_squad_files.uploaders.openai import OpenAIFileUploader
