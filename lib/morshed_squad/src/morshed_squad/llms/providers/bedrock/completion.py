...
class BedrockCompletion(BaseLLM):
    ...
    def _format_tools_for_converse(
        ...
        """Convert Morshed Squad tools to Converse API format following AWS specification."""
    ...
    def get_context_window_size(self) -> int:
        ...
        from morshed_squad.llm import CONTEXT_WINDOW_USAGE_RATIO
    ...
    def get_file_uploader(self) -> Any:
        ...
        try:
            import boto3
            from morshed_squad_files.uploaders.bedrock import BedrockFileUploader
