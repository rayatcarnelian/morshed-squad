"""Base LLM abstract class for Morshed Squad.

This module provides the abstract base class for all LLM implementations
in Morshed Squad, including common functionality for native SDK implementations.
"""
...
try:
    from morshed_squad_files import format_multimodal_content
...
class BaseLLM(ABC):
    ...
    def _emit_call_started_event(
        ...
        from morshed_squad.utilities.serialization import to_serializable
