...
from morshed_squad.cli.authentication.utils import validate_jwt_token
from morshed_squad.cli.config import Settings
from morshed_squad.cli.shared.token_manager import TokenManager
...
if TYPE_CHECKING:
    from morshed_squad.cli.authentication.providers.base_provider import BaseProvider
...
class ProviderFactory:
    ...
    def from_settings(
        ...
        module = importlib.import_module(
            f"morshed_squad.cli.authentication.providers.{settings.provider.lower()}"
        )
...
class AuthenticationCommand:
    ...
    def login(self) -> None:
        """Sign up to Morshed Squad+"""
        console.print("Signing in to Morshed Squad AMP...\n", style="bold blue")
    ...
    def _poll_for_token(self, device_code_data: dict[str, Any]) -> None:
        ...
        while True and attempts < 10:
            ...
            if response.status_code == 200:
                ...
                console.print("\n[bold green]Welcome to Morshed Squad AMP![/bold green]\n")
                return
