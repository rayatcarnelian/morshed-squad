...
from morshed_squad.cli.authentication.main import Oauth2Settings, ProviderFactory
from morshed_squad.cli.command import BaseCommand
...
class EnterpriseConfigureCommand(BaseCommand):
    ...
    def configure(self, enterprise_url: str) -> None:
        try:
            ...
            console.print(
                f"✅ Successfully configured Morshed Squad AMP with OAuth2 settings from {enterprise_url}",
                style="bold green",
            )
    ...
    def _fetch_oauth_config(self, enterprise_url: str) -> dict[str, Any]:
        ...
        try:
            ...
            headers = {
                ...
                "User-Agent": f"Morshed Squad-CLI/{get_crewai_version()}",
