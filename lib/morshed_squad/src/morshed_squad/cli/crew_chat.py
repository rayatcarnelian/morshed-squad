...
from morshed_squad.cli.utils import read_toml
...
from morshed_squad.types.crew_chat import ChatInputField, ChatInputs
...
def build_system_message(crew_chat_inputs: ChatInputs) -> str:
    ...
    return (
        "You are a helpful AI assistant for the Morshed Squad platform. "
