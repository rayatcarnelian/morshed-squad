...
from morshed_squad.cli.constants import (
...
DEFAULT_CONFIG_PATH = Path.home() / ".config" / "morshed_squad" / "settings.json"
...
class Settings(BaseModel):
    enterprise_base_url: str | None = Field(
        ...
        description="Base URL of the Morshed Squad AMP instance",
    )
