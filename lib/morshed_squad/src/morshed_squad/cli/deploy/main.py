...
from morshed_squad.cli.utils import fetch_and_json_env_file, get_project_name
...
class DeployCommand(BaseCommand, PlusAPIMixin):
    """
    A class to handle deployment-related operations for Morshed Squad projects.
    """
