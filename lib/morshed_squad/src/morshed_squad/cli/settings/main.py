...
from morshed_squad.cli.config import HIDDEN_SETTINGS_KEYS, READONLY_SETTINGS_KEYS, Settings
from morshed_squad.events.listeners.tracing.utils import _load_user_data
...
class SettingsCommand(BaseCommand):
    ...
    def list(self) -> None:
        ...
        table = Table(title="Morshed Squad CLI Configuration")
