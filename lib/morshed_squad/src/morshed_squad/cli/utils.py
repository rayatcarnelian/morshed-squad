...
from morshed_squad.cli.constants import ENV_VARS
from morshed_squad.crew import Crew
from morshed_squad.flow import Flow
...
def _get_project_attribute(
    ...
    try:
        ...
        if not any(True for dep in dependencies if "morshed_squad" in dep):
...
def is_valid_tool(obj: Any) -> bool:
    from morshed_squad.tools.base_tool import Tool
...
def _print_no_tools_warning() -> None:
    ...
    console.print(
        ...
        "[green]from morshed_squad.tools import BaseTool, tool\n\n"
        "# Tool class example\n"
