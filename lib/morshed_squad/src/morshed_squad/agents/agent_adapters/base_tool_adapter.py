...
from morshed_squad.utilities.string_utils import sanitize_tool_name as _sanitize_tool_name
...
class BaseToolAdapter(ABC):
    """Base class for all tool adapters in Morshed Squad.

    This abstract class defines the common interface that all tool adapters
    must implement. It provides the structure for adapting Morshed Squad tools to
