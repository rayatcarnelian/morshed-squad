"""LangGraph agent adapter for Morshed Squad integration.

This module contains the LangGraphAgentAdapter class that integrates LangGraph ReAct agents
with Morshed Squad's agent system. Provides memory persistence, tool integration, and structured
...
from morshed_squad.agents.agent_adapters.base_agent_adapter import BaseAgentAdapter
from morshed_squad.agents.agent_adapters.langgraph.langgraph_tool_adapter import (
    LangGraphToolAdapter,
)
from morshed_squad.agents.agent_adapters.langgraph.protocols import (
    LangGraphCheckPointMemoryModule,
    LangGraphPrebuiltModule,
)
from morshed_squad.agents.agent_adapters.langgraph.structured_output_converter import (
...
from morshed_squad.utilities import Logger
from morshed_squad.utilities.converter import Converter
from morshed_squad.utilities.import_utils import require


class LangGraphAgentAdapter(BaseAgentAdapter):
    """Adapter for LangGraph agents to work with Morshed Squad.

    This adapter integrates LangGraph's ReAct agents with Morshed Squad's agent system,
