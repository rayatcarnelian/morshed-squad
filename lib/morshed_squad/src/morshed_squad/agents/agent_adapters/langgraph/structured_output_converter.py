"""LangGraph structured output converter for Morshed Squad task integration.
...
from morshed_squad.agents.agent_adapters.base_converter_adapter import BaseConverterAdapter
