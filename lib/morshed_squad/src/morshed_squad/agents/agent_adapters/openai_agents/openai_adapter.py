"""OpenAI agents adapter for Morshed Squad integration.

This module contains the OpenAIAgentAdapter class that integrates OpenAI Assistants
with Morshed Squad's agent system, providing tool integration and structured output support.
"""
...
from morshed_squad.agents.agent_adapters.openai_agents.openai_agent_tool_adapter import (
...
from morshed_squad.agents.agent_adapters.openai_agents.structured_output_converter import (
...
class OpenAIAgentAdapter(BaseAgentAdapter):
    ...
    Integrates OpenAI Assistants API with Morshed Squad's agent system, providing
