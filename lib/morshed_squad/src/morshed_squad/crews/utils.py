...
from morshed_squad.utilities.file_store import store_files
...
try:
    from morshed_squad_files import (
        AudioFile,
        ImageFile,
        PDFFile,
        TextFile,
...
def prepare_kickoff(
    ...
    from morshed_squad.events.event_context import get_current_parent_id, reset_last_event_id
    from morshed_squad.events.types.crew_events import CrewKickoffStartedEvent
