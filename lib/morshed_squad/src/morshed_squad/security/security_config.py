...
This module provides configuration for Morshed Squad security features, including:
- Authentication settings
- Scoping rules
- Fingerprinting

The SecurityConfig class is the primary interface for managing security settings
in Morshed Squad applications.
"""
...
class SecurityConfig(BaseModel):
    """
    Configuration for Morshed Squad security features.

    This class manages security settings for Morshed Squad agents, including:
