...
from morshed_squad.a2a.extensions.base import (
    A2AExtension,
    ConversationState,
    ExtensionRegistry,
)
from morshed_squad.a2a.task_helpers import TaskStateResult
from morshed_squad.a2a.templates import (
...
from morshed_squad.a2a.utils.delegation import (
...
def _handle_task_completion(
    ...
    Args:
        ...
        task: MorshedSquad Task object to update with reference IDs.
        ...
        from_task: Optional Morshed Squad Task for event metadata.
        from_agent: Optional Morshed Squad Agent for event metadata.
...
def _handle_agent_response_and_continue(
    ...
    """Handle A2A result and get Morshed Squad agent's response.
