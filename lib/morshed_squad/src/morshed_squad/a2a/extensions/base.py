"""Base extension interface for Morshed Squad A2A wrapper processing hooks.

This module defines the protocol for extending Morshed Squad's A2A wrapper functionality
with custom logic for tool injection, prompt augmentation, and response processing.

Note: These are Morshed Squad-specific processing hooks, NOT A2A protocol extensions.
