...
from morshed_squad.a2a.utils.agent_card import _get_server_config
from morshed_squad.a2a.utils.content_type import validate_message_parts
...
if TYPE_CHECKING:
    from morshed_squad.a2a.extensions.server import ExtensionContext, ServerExtensionRegistry
...
def _convert_a2a_files_to_file_inputs(
    ...
    """
    try:
        from morshed_squad_files import File, FileBytes
    except ImportError:
...
async def execute(
    ...
    """Execute an A2A task using a Morshed Squad agent.

    Args:
        agent: The Morshed Squad agent to execute the task.
