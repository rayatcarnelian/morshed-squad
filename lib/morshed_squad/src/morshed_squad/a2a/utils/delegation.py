...
from morshed_squad.a2a.auth.client_schemes import APIKeyAuth, HTTPDigestAuth
from morshed_squad.a2a.auth.utils import (
    _auth_store,
    configure_auth_client,
    validate_auth_against_agent_card,
)
from morshed_squad.a2a.config import ClientTransportConfig, GRPCClientConfig
from morshed_squad.a2a.extensions.registry import (
    ExtensionsMiddleware,
    validate_required_extensions,
)
from morshed_squad.a2a.task_helpers import TaskStateResult
from morshed_squad.a2a.types import (
    HANDLER_REGISTRY,
    HandlerType,
    PartsDict,
    PartsMetadataDict,
...
from morshed_squad.a2a.updates import (
    PollingConfig,
    PushNotificationConfig,
    StreamingHandler,
    UpdateConfig,
)
from morshed_squad.a2a.utils.agent_card import (
    _afetch_agent_card_cached,
    _get_tls_verify,
    _prepare_auth_headers,
)
from morshed_squad.a2a.utils.content_type import (
    DEFAULT_CLIENT_OUTPUT_MODES,
    negotiate_content_types,
)
from morshed_squad.a2a.utils.transport import (
    NegotiatedTransport,
...
if TYPE_CHECKING:
    ...
    from morshed_squad.a2a.auth.client_schemes import ClientAuthScheme
...
def _create_file_parts(input_files: dict[str, Any] | None) -> list[Part]:
    ...
    try:
        import morshed_squad_files  # noqa: F401
    except ImportError:
...
def execute_a2a_delegation(
    ...
    Args:
        ...
        agent_role: Role of the Morshed Squad agent delegating the task.
        agent_branch: Optional agent tree branch for logging.
        response_model: Optional Pydantic model for structured outputs.
        turn_number: Optional turn number for multi-turn conversations.
        updates: Update mechanism config from A2AConfig.updates.
        from_task: Optional Morshed Squad Task object for event metadata.
        from_agent: Optional Morshed Squad Agent object for event metadata.
...
def _create_grpc_channel_factory(
    ...
    if auth is not None:
        from morshed_squad.a2a.auth.client_schemes import (
            APIKeyAuth,
            BearerTokenAuth,
            HTTPBasicAuth,
            HTTPDigestAuth,
