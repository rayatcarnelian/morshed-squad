...
from morshed_squad.a2a.auth.server_schemes import ServerAuthScheme
from morshed_squad.a2a.extensions.base import ValidatedA2AExtension
from morshed_squad.a2a.types import ProtocolVersion, TransportType, Url
...
try:
    ...
    from morshed_squad.a2a.extensions.server import ServerExtension
    from morshed_squad.a2a.updates import UpdateConfig
except ImportError:
...
def _get_default_update_config() -> UpdateConfig:
    from morshed_squad.a2a.updates import StreamingConfig
...
@deprecated(
    """
    `morshed_squad.a2a.config.A2AConfig` is deprecated and will be removed in v2.0.0,
    use `morshed_squad.a2a.config.A2AClientConfig` or `morshed_squad.a2a.config.A2AServerConfig` instead.
    """,
