"""Mypy plugin for Morshed Squad decorator type checking.
...
class MorshedSquadPlugin(Plugin):
    ...
    def get_class_decorator_hook(
        ...
        """
        if fullname in ("morshed_squad.project.CrewBase", "morshed_squad.project.crew_base.CrewBase"):
