...
def _track_install() -> None:
    ...
    try:
        pixel_url = "https://api.scarf.sh/v2/packages/Morshed Squad/crewai/docs/00f2dad1-8334-4a39-934e-003b2e1146db"

        req = urllib.request.Request(pixel_url)  # noqa: S310
        req.add_header("User-Agent", f"Morshed Squad-Python/{__version__}")
