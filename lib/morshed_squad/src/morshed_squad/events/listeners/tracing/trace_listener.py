...
from morshed_squad.cli.authentication.token import AuthError, get_auth_token
from morshed_squad.cli.version import get_crewai_version
from morshed_squad.events.base_event_listener import BaseEventListener
from morshed_squad.events.base_events import BaseEvent
from morshed_squad.events.event_bus import MorshedSquadEventsBus
from morshed_squad.events.listeners.tracing.first_time_trace_handler import (
    FirstTimeTraceHandler,
)
from morshed_squad.events.listeners.tracing.trace_batch_manager import TraceBatchManager
from morshed_squad.events.listeners.tracing.types import TraceEvent
...
from morshed_squad.events.types.system_events import SignalEvent, on_signal
...
class TraceCollectionListener(BaseEventListener):
    ...
    def _register_flow_event_handlers(self, event_bus: MorshedSquadEventsBus) -> None:
    ...
    def _register_context_event_handlers(self, event_bus: MorshedSquadEventsBus) -> None:
    ...
    def _register_action_event_handlers(self, event_bus: MorshedSquadEventsBus) -> None:
    ...
    def _register_a2a_event_handlers(self, event_bus: MorshedSquadEventsBus) -> None:
    ...
    def _register_system_event_handlers(self, event_bus: MorshedSquadEventsBus) -> None:
