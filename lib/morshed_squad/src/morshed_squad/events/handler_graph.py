...
from morshed_squad.events.types.event_bus_types import ExecutionPlan, Handler
...
class HandlerGraph:
    ...
    def __init__(
        ...
        Args:
            handlers: Mapping of handler -> list of `morshed_squad.events.depends.Depends` objects
        """
        self.handlers = handlers
