...
from morshed_squad.cli.version import is_current_version_yanked, is_newer_version_available
    ...
    def _show_version_update_message_if_needed(self) -> None:
        ...
        try:
            ...
            if is_newer and latest:
                message = f"""A new version of Morshed Squad is available!
...
• Run: crewai traces enable"""
    ...
    def handle_agent_logs_execution(
        ...
        from morshed_squad.agents.parser import AgentAction, AgentFinish
