...
from morshed_squad.project.wrappers import CrewClass, CrewMetadata
from morshed_squad.tools import BaseTool


if TYPE_CHECKING:
    from morshed_squad import Agent, Task
    ...
    from morshed_squad.project.wrappers import (
        CrewInstance,
        OutputJsonClass,
        OutputPydanticClass,
    )
...
def _register_crew_hooks(instance: CrewInstance, cls: type) -> None:
    ...
    from morshed_squad.hooks import (
