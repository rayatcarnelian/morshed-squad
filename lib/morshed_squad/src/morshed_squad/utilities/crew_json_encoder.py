"""JSON encoder for handling Morshed Squad specific types."""
...
class CrewJSONEncoder(json.JSONEncoder):
    """Custom JSON encoder for Morshed Squad objects and special types."""

    def default(self, obj: Any) -> Any:
        """Custom serialization for Morshed Squad specific types.
