...
from morshed_squad.context import reset_current_task_id, set_current_task_id
from morshed_squad.core.providers.content_processor import process_content
...
from morshed_squad.security import Fingerprint, SecurityConfig
from morshed_squad.tasks.output_format import OutputFormat
from morshed_squad.tasks.task_output import TaskOutput
from morshed_squad.tools.base_tool import BaseTool
from morshed_squad.utilities.config import process_config
from morshed_squad.utilities.constants import NOT_SPECIFIED, _NotSpecified
from morshed_squad.utilities.converter import Converter, convert_to_model
from morshed_squad.utilities.file_store import (
    clear_task_files,
    get_all_files,
    store_task_files,
)
...
try:
    from morshed_squad_files import FileInput, FilePath, get_supported_content_types
...
from morshed_squad.utilities.guardrail import (
    process_guardrail,
)
from morshed_squad.utilities.guardrail_types import (
    GuardrailCallable,
    GuardrailType,
    GuardrailsType,
)
...
from morshed_squad.utilities.string_utils import interpolate_only
...
class Task(BaseModel):
    ...
    def handle_max_retries_deprecation(self) -> Self:
        if self.max_retries is not None:
            warnings.warn(
                "The 'max_retries' parameter is deprecated and will be removed in Morshed Squad v1.0.0. "
...
- Use ```language for code blocks"""
    ...
    def _save_file(self, result: dict[str, Any] | str | Any) -> None:
        ...
        Note:
            ...
            from the morshed_squad_tools package:
                pip install 'crewai[tools]'
                from morshed_squad_tools import FileWriterTool
        ...
        Raises:
            ...
            RuntimeError: If there is an error writing to the file. For cross-platform
                compatibility, especially on Windows, use FileWriterTool from morshed_squad_tools
                package.
        """
        ...
        filewriter_recommendation = (
            ...
            "use FileWriterTool from morshed_squad_tools package."
        )
